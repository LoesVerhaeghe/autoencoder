...
# ### perceptual loss
# RECONSTRUCTION_LOSS_WEIGHT = 1  # Weight for MSE/SSIM
# PERCEPTUAL_LOSS_WEIGHT = 0 # Weight for Perceptual Loss (tune this)
...
# ### load data
# base_folder = "data/filtered_data/microscope_images_CLAHE"
...
# dataset_10x = MicroscopicImages(root=dst_folder, magnification=10, transform=None)
# dataset_40x = MicroscopicImages(root=dst_folder, magnification=40, transform=None)
...
#             encoded_image = model(image_data, get_encoded=True)
...
# encode_images(dataset_10x)
# encode_images(dataset_40x)
